"""
Noise Sweep — p=0.001 only, N=8 (standalone, run independently)
Run AFTER run_qubit_8_noiseless.py so p=0 is already in scaling_noise.csv.
This appends/replaces only the p=0.001 row.

WARNING: density-matrix sim is ~45x slower than statevector.
Expect ~50-60 min for 300 train + 150 test samples at N=8.

Usage: python run_noise_p001.py
"""
